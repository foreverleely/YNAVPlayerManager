...
@implementation YNAVPlayerManager
...
- (instancetype)initWithFilePath:(NSString *)filePath andFrame:(CGRect)frame
{
    ...
    if (asset) {
        ...
        // add notific
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(yn_PlayerPlaybackFinished:) name:AVPlayerItemDidPlayToEndTimeNotification object:self.playerItem];
...
- (void)yn_PlayerPlaybackFinished:(NSNotification *)notification {
